...
def apply_preprocessing(X, preprocess_artifacts):
    ...
    # Build the final matrix directly from the saved training dummy columns.
    # This avoids the one-row get_dummies/drop_first deployment bug.
    ...
    if result is None:
        ...
        st.markdown(
            ...
            <div class="info-card">
                ...
                <strong>Approve</strong>: repayment probability meets the approval threshold and predicted pessimistic return is nonnegative.<br>
                <strong>Review</strong>: repayment probability is between the approval and rejection thresholds.<br>
                <strong>Reject</strong>: repayment probability is below the rejection threshold or predicted pessimistic return is negative.
            </div>
            """,
            unsafe_allow_html=True
        )
